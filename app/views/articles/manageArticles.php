...
<body class="a-body">
    ...
    <div class="m-articles">
        ...
        <div class="myBtnContainer A-btns">
            <button class="btn" onclick="filterSelection('myArticles')"> My Articles</button>
            <button class="btn" onclick="filterSelection('addArticles')"> Add Article</button>
        </div>

        <div class="container">
            <div class="filterDiv myArticles">
                <?php if ($data) : ?>
            ...
            <div class="filterDiv addArticles">
