                            ...
                            <?php foreach ($rows as $row) : ?>
                                <div class='body_container'>
                                    ...
                                    <div class='body_container2'>
                                        ...
                                        <br>
                                        <div class="line2">
                                            <p style="text-align:left;"><?= esc($row->description) ?></p>
                                        </div><br>
                                        <?php if ($row->tpNumber) : ?>
                                            <div class="line3">
                                                <p style="text-align:left;">Contact Number:<?= esc($row->tpNumber) ?></p>
                                            </div>
                                        <?php endif; ?>
                                        <?php if ($row->location) : ?>
                                            <div class="line3">
                                                <p style="text-align:left;">Location: <?= esc($row->location) ?></p>
                                            </div>
                                        <?php endif; ?>
                                        <div class="forum_buttons">
                                            ...
                                            <?php if (Auth::logged_in()) : ?>
                                                ...
                                                if( $row->forumDoctorid){
                                                $forumid = $row->forumDoctorid;
                                                $useridforumrow = $forumdoctor->where('forumDoctorid', $forumid);
                                                // print_r($useridforumrow);
                                                // die;
                                                $useridforum = $useridforumrow[0]->forumDoctorid;
                                                }
                                                $userid = Auth::userid();
                                                ?>
