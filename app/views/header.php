...
<body>
    ...
    <header>
        ...
        <nav class="top_nav" id="myTopnav">
                ...
                <a class="a_navitem2" href="<?= ROOT ?>home/home"><img class="logo" src="<?= ASSETS ?>img/logo.png"></a>
                <a class="a_navitem2 items" href="<?= ROOT ?>home/home">HOME</a>
                <div class="v"></div>
                ...
                <?php endif;?>
                <div class="v"></div>
                <a class="a_navitem2 items" href="<?= ROOT ?>forums">FORUMS</a>
